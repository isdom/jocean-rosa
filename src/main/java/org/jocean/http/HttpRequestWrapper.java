...
public class HttpRequestWrapper {
    ...
    public void transferRequestAndContents(
    		final HttpClientWrapper clientWrapper,
    		final HttpReactor<Integer> httpReactor ) {
        clientWrapper.sendHttpRequest(
            this._httpRequest, httpReactor);
        for ( HttpContent content : this._contents) {
        	clientWrapper.sendHttpContent(content);
        }
    }
