 ...
 * created by this factory sends a bogus certificate defined in {@link J2SESslKeyStore}.
 * <p>
 ...
 * </ul>
 */
public final class J2SESslContextFactory {
    ...
    static {
        ...
        try {
            ...
            ks.load(J2SESslKeyStore.asInputStream(),
                    J2SESslKeyStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, J2SESslKeyStore.getCertificatePassword());
